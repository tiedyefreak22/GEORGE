...
# python create_coco_tf_record.py --logtostderr \
#       --train_image_dir=/Dataset/Custom_Dataset/Train \
#       --test_image_dir=/Dataset/Custom_Dataset/Validation \
#       --val_image_dir=/Dataset/Custom_Dataset/Validation \
#       --train_annotations_file=custom_bee_dataset.json \
#       --val_annotations_file=custom_bee_dataset.json \
#       --testdev_annotations_file=custom_bee_dataset.json \
#       --output_dir=/Dataset/tfrecords


# python create_coco_tf_record.py --logtostderr --train_image_dir=/Dataset/Custom_Dataset/Train --test_image_dir=/Dataset/Custom_Dataset/Validation --val_image_dir=/Dataset/Custom_Dataset/Validation --train_annotations_file=custom_bee_dataset.json --val_annotations_file=custom_bee_dataset.json --testdev_annotations_file=custom_bee_dataset.json --output_dir=/Dataset/tfrecords
...
def create_tf_example(image,
  ...
  filename = str(image['file_name']) + ".png"
  image_id = image['id']
